...
type ApiCopyContentRequest struct {
	ctx _context.Context
	ApiService *DebCopyApiService
	copy *Copy
}

func (r ApiCopyContentRequest) Copy(copy Copy) ApiCopyContentRequest {
	r.copy = &copy
	return r
}

func (r ApiCopyContentRequest) Execute() (AsyncOperationResponse, *_nethttp.Response, error) {
 ...
 * @return ApiCopyContentRequest
 */
func (a *DebCopyApiService) CopyContent(ctx _context.Context) ApiCopyContentRequest {
	return ApiCopyContentRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *DebCopyApiService) CopyContentExecute(r ApiCopyContentRequest) (AsyncOperationResponse, *_nethttp.Response, error) {
	var (
