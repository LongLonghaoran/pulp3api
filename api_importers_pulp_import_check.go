...
func (r ApiPulpImportCheckPostRequest) Execute() (*PulpImportCheckResponse, *http.Response, error) {
...
*/
func (a *ImportersPulpImportCheckApiService) PulpImportCheckPost(ctx context.Context) ApiPulpImportCheckPostRequest {
	return ApiPulpImportCheckPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ImportersPulpImportCheckApiService) PulpImportCheckPostExecute(r ApiPulpImportCheckPostRequest) (*PulpImportCheckResponse, *http.Response, error) {
	var (
