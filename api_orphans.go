...
func (r ApiOrphansDeleteRequest) Execute() (*AsyncOperationResponse, *http.Response, error) {
...
*/
func (a *OrphansApiService) OrphansDelete(ctx context.Context) ApiOrphansDeleteRequest {
	return ApiOrphansDeleteRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *OrphansApiService) OrphansDeleteExecute(r ApiOrphansDeleteRequest) (*AsyncOperationResponse, *http.Response, error) {
	var (
