...
type ApiOrphansDeleteRequest struct {
	ctx _context.Context
	ApiService *OrphansApiService
}


func (r ApiOrphansDeleteRequest) Execute() (AsyncOperationResponse, *_nethttp.Response, error) {
 ...
 * @return ApiOrphansDeleteRequest
 */
func (a *OrphansApiService) OrphansDelete(ctx _context.Context) ApiOrphansDeleteRequest {
	return ApiOrphansDeleteRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *OrphansApiService) OrphansDeleteExecute(r ApiOrphansDeleteRequest) (AsyncOperationResponse, *_nethttp.Response, error) {
	var (
