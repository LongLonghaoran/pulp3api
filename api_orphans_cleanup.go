...
func (r ApiOrphansCleanupCleanupRequest) Execute() (AsyncOperationResponse, *_nethttp.Response, error) {
 ...
 */
func (a *OrphansCleanupApiService) OrphansCleanupCleanup(ctx _context.Context) ApiOrphansCleanupCleanupRequest {
	return ApiOrphansCleanupCleanupRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *OrphansCleanupApiService) OrphansCleanupCleanupExecute(r ApiOrphansCleanupCleanupRequest) (AsyncOperationResponse, *_nethttp.Response, error) {
	var (
