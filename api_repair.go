...
func (r ApiRepairPostRequest) Execute() (AsyncOperationResponse, *_nethttp.Response, error) {
 ...
 */
func (a *RepairApiService) RepairPost(ctx _context.Context) ApiRepairPostRequest {
	return ApiRepairPostRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *RepairApiService) RepairPostExecute(r ApiRepairPostRequest) (AsyncOperationResponse, *_nethttp.Response, error) {
	var (
