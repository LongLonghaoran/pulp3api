...
func (r ApiRepositoriesDebAptVersionsDeleteRequest) Execute() (AsyncOperationResponse, *_nethttp.Response, error) {
 ...
 */
func (a *RepositoriesAptVersionsApiService) RepositoriesDebAptVersionsDelete(ctx _context.Context, number int32, repositoryPk string) ApiRepositoriesDebAptVersionsDeleteRequest {
	return ApiRepositoriesDebAptVersionsDeleteRequest{
		ApiService: a,
		ctx: ctx,
		number: number,
 ...
 */
func (a *RepositoriesAptVersionsApiService) RepositoriesDebAptVersionsDeleteExecute(r ApiRepositoriesDebAptVersionsDeleteRequest) (AsyncOperationResponse, *_nethttp.Response, error) {
	var (
...
func (r ApiRepositoriesDebAptVersionsListRequest) Execute() (PaginatedRepositoryVersionResponseList, *_nethttp.Response, error) {
 ...
 */
func (a *RepositoriesAptVersionsApiService) RepositoriesDebAptVersionsList(ctx _context.Context, repositoryPk string) ApiRepositoriesDebAptVersionsListRequest {
	return ApiRepositoriesDebAptVersionsListRequest{
		ApiService: a,
		ctx: ctx,
		repositoryPk: repositoryPk,
 ...
 */
func (a *RepositoriesAptVersionsApiService) RepositoriesDebAptVersionsListExecute(r ApiRepositoriesDebAptVersionsListRequest) (PaginatedRepositoryVersionResponseList, *_nethttp.Response, error) {
	var (
...
func (r ApiRepositoriesDebAptVersionsReadRequest) Execute() (RepositoryVersionResponse, *_nethttp.Response, error) {
 ...
 */
func (a *RepositoriesAptVersionsApiService) RepositoriesDebAptVersionsRead(ctx _context.Context, number int32, repositoryPk string) ApiRepositoriesDebAptVersionsReadRequest {
	return ApiRepositoriesDebAptVersionsReadRequest{
		ApiService: a,
		ctx: ctx,
		number: number,
 ...
 */
func (a *RepositoriesAptVersionsApiService) RepositoriesDebAptVersionsReadExecute(r ApiRepositoriesDebAptVersionsReadRequest) (RepositoryVersionResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiRepositoriesDebAptVersionsRepairRequest) Execute() (AsyncOperationResponse, *_nethttp.Response, error) {
 ...
 */
func (a *RepositoriesAptVersionsApiService) RepositoriesDebAptVersionsRepair(ctx _context.Context, number int32, repositoryPk string) ApiRepositoriesDebAptVersionsRepairRequest {
	return ApiRepositoriesDebAptVersionsRepairRequest{
		ApiService: a,
		ctx: ctx,
		number: number,
 ...
 * @return AsyncOperationResponse
 */
func (a *RepositoriesAptVersionsApiService) RepositoriesDebAptVersionsRepairExecute(r ApiRepositoriesDebAptVersionsRepairRequest) (AsyncOperationResponse, *_nethttp.Response, error) {
	var (
