...
const (
	DOCKER_DISTRIBUTION_MANIFEST_V1JSON MediaTypesEnum = "application/vnd.docker.distribution.manifest.v1+json"
	DOCKER_DISTRIBUTION_MANIFEST_V2JSON MediaTypesEnum = "application/vnd.docker.distribution.manifest.v2+json"
	DOCKER_DISTRIBUTION_MANIFEST_LIST_V2JSON MediaTypesEnum = "application/vnd.docker.distribution.manifest.list.v2+json"
	OCI_IMAGE_MANIFEST_V1JSON MediaTypesEnum = "application/vnd.oci.image.manifest.v1+json"
	OCI_IMAGE_INDEX_V1JSON MediaTypesEnum = "application/vnd.oci.image.index.v1+json"
)
