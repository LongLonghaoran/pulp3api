...
// PaginatedAlternateContentSourceResponseList struct for PaginatedAlternateContentSourceResponseList
type PaginatedAlternateContentSourceResponseList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results []AlternateContentSourceResponse `json:"results,omitempty"`
}
...
func NewPaginatedAlternateContentSourceResponseList() *PaginatedAlternateContentSourceResponseList {
	this := PaginatedAlternateContentSourceResponseList{}
	return &this
}
...
func (o *PaginatedAlternateContentSourceResponseList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedAlternateContentSourceResponseList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o *PaginatedAlternateContentSourceResponseList) GetResults() []AlternateContentSourceResponse {
	if o == nil || o.Results == nil {
		var ret []AlternateContentSourceResponse
		return ret
	}
	return o.Results
}
...
// SetResults gets a reference to the given []AlternateContentSourceResponse and assigns it to the Results field.
func (o *PaginatedAlternateContentSourceResponseList) SetResults(v []AlternateContentSourceResponse) {
	o.Results = v
}

func (o PaginatedAlternateContentSourceResponseList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedAlternateContentSourceResponseList struct {
	value *PaginatedAlternateContentSourceResponseList
	isSet bool
}

func (v NullablePaginatedAlternateContentSourceResponseList) Get() *PaginatedAlternateContentSourceResponseList {
	return v.value
}

func (v *NullablePaginatedAlternateContentSourceResponseList) Set(val *PaginatedAlternateContentSourceResponseList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedAlternateContentSourceResponseList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedAlternateContentSourceResponseList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedAlternateContentSourceResponseList(val *PaginatedAlternateContentSourceResponseList) *NullablePaginatedAlternateContentSourceResponseList {
	return &NullablePaginatedAlternateContentSourceResponseList{value: val, isSet: true}
}

func (v NullablePaginatedAlternateContentSourceResponseList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedAlternateContentSourceResponseList) UnmarshalJSON(src []byte) error {
	v.isSet = true
