...
// PaginatedExportResponseList struct for PaginatedExportResponseList
type PaginatedExportResponseList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results *[]ExportResponse `json:"results,omitempty"`
}
...
func NewPaginatedExportResponseList() *PaginatedExportResponseList {
	this := PaginatedExportResponseList{}
	return &this
}
...
func (o *PaginatedExportResponseList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedExportResponseList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []ExportResponse and assigns it to the Results field.
func (o *PaginatedExportResponseList) SetResults(v []ExportResponse) {
	o.Results = &v
}

func (o PaginatedExportResponseList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedExportResponseList struct {
	value *PaginatedExportResponseList
	isSet bool
}

func (v NullablePaginatedExportResponseList) Get() *PaginatedExportResponseList {
	return v.value
}

func (v *NullablePaginatedExportResponseList) Set(val *PaginatedExportResponseList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedExportResponseList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedExportResponseList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedExportResponseList(val *PaginatedExportResponseList) *NullablePaginatedExportResponseList {
	return &NullablePaginatedExportResponseList{value: val, isSet: true}
}

func (v NullablePaginatedExportResponseList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedExportResponseList) UnmarshalJSON(src []byte) error {
	v.isSet = true
