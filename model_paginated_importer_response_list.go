...
// PaginatedImporterResponseList struct for PaginatedImporterResponseList
type PaginatedImporterResponseList struct {
	Count *int32 `json:"count,omitempty"`
	Next NullableString `json:"next,omitempty"`
	Previous NullableString `json:"previous,omitempty"`
	Results []ImporterResponse `json:"results,omitempty"`
}
...
func NewPaginatedImporterResponseList() *PaginatedImporterResponseList {
	this := PaginatedImporterResponseList{}
	return &this
}
...
func (o *PaginatedImporterResponseList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedImporterResponseList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []ImporterResponse and assigns it to the Results field.
func (o *PaginatedImporterResponseList) SetResults(v []ImporterResponse) {
	o.Results = v
}

func (o PaginatedImporterResponseList) MarshalJSON() ([]byte, error) {
...
type NullablePaginatedImporterResponseList struct {
	value *PaginatedImporterResponseList
	isSet bool
}

func (v NullablePaginatedImporterResponseList) Get() *PaginatedImporterResponseList {
	return v.value
}

func (v *NullablePaginatedImporterResponseList) Set(val *PaginatedImporterResponseList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedImporterResponseList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedImporterResponseList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedImporterResponseList(val *PaginatedImporterResponseList) *NullablePaginatedImporterResponseList {
	return &NullablePaginatedImporterResponseList{value: val, isSet: true}
}

func (v NullablePaginatedImporterResponseList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedImporterResponseList) UnmarshalJSON(src []byte) error {
	v.isSet = true
