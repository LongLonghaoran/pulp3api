...
type PatcheddebAptRemote struct {
	...
	Policy NullablePolicy762Enum `json:"policy,omitempty"`
...
// SetPolicy gets a reference to the given NullablePolicy762Enum and assigns it to the Policy field.
func (o *PatcheddebAptRemote) SetPolicy(v Policy762Enum) {
	o.Policy.Set(&v)
}
// SetPolicyNil sets the value for Policy to be an explicit nil
func (o *PatcheddebAptRemote) SetPolicyNil() {
	o.Policy.Set(nil)
}
...
func (o *PatcheddebAptRemote) GetIgnoreMissingPackageIndices() bool {
	if o == nil || o.IgnoreMissingPackageIndices == nil {
		var ret bool
		return ret
	}
